...
class PestDetectionInfoUseCase extends UseCase<PestDetectionInfoEntity, int> {
  final PestDetectionRepo pestDetectionRepo;

  PestDetectionInfoUseCase({required this.pestDetectionRepo});

  @override
  Future<Either<FailureModel, PestDetectionInfoEntity>> call(int params) {
    return pestDetectionRepo.getPestDetectionInfo(params);
  }
}
